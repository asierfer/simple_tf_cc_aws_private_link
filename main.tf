...
resource "confluent_network" "private-link" {
  display_name     = "${var.prefix}-Private Link Network"
  cloud            = "AWS"
  region           = var.region
...
resource "confluent_private_link_access" "aws" {
  display_name = "${var.prefix}-AWS Private Link Access"
  aws {
...
resource "confluent_kafka_cluster" "dedicated" {
  display_name = "${var.prefix}-inventory"
...
resource "aws_security_group" "privatelink" {
  ...
  name        = "${var.prefix}-ccloud-privatelink_${local.bootstrap_prefix}_${var.vpc_id}"
